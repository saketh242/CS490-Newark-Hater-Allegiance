          ...
          {openG[0] ? <div id='guide-text'>
            <div className='box' id="guide-div">
              ...
              <div className='signup' id='guide-video-div'>
                <iframe id='guide-video' src="https://youtu.be/zqyxSMqNJ3g?si=BK-_r68myyyDLP2M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              </div>
            </div>
          </div> : null}
          {/*TRANSLATING GUIDE*/}
